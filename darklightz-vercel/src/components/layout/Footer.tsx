        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 mb-24 md:mb-32">
          <div className="max-w-sm">
            ...
            <div className="flex gap-4">
              <a href="#" aria-label="Twitter" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-muted-foreground transition-colors">
              ...
              <a href="#" aria-label="LinkedIn" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-muted-foreground transition-colors">
              ...
              <a href="#" aria-label="Dribbble" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-muted-foreground transition-colors">
          ...
          <div className="flex flex-wrap gap-12 md:gap-24">
            <div>
              ...
              <ul className="space-y-4 text-sm text-muted-foreground">
                ...
                <li><Link href="/pricing" className="hover:text-foreground transition-colors block">Pricing Models</Link></li>
              </ul>
            </div>
            <div>
