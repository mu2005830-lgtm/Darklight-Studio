      ...
      <div className="pt-32 pb-20 bg-black min-h-[100dvh]">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-32 mb-32">
            <div>
              <div className="aspect-[3/4] bg-neutral-900 border border-white/10">
                <img 
            ...
            <div className="flex flex-col justify-center">
              <h2 className="text-3xl font-display font-bold mb-8">The Studio Story</h2>
          ...
          <div className="border-t border-white/10 pt-32">
            <h2 className="text-4xl font-display font-bold mb-16 text-center">Core Principles.</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div 
                  ...
                  className="p-8 border border-white/10 bg-[#050505]"
                >
