  ...
  return (
    <PublicLayout>
      <div className="pt-32 pb-20 bg-black">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-20">
            <h1 className="text-5xl md:text-7xl font-display font-bold mb-6">Our Work.</h1>
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <button
              ...
              className={`px-6 py-2 font-display uppercase tracking-widest text-xs font-semibold transition-colors border ${
                !activeCategory 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <AnimatePresence mode="popLayout">
              {projects?.map((project) => (
                ...
                >
                  <div className="aspect-[4/3] overflow-hidden mb-6 relative bg-white/5 border border-white/10">
                    <img 
      ...
      <Dialog open={!!selectedProjectId} onOpenChange={(open) => !open && setSelectedProjectId(null)}>
        <DialogContent className="max-w-3xl bg-[#0a0a0a] border-white/10 p-0 overflow-hidden gap-0 rounded-none">
          {selectedProject && (
            <>
              ...
              <div className="p-8">
                <DialogHeader className="mb-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="text-sm border border-white/20 px-3 py-1 font-mono text-neutral-400">{selectedProject.year}</span>
                  </div>
                ...
                <div className="flex flex-wrap gap-2 mt-8 border-t border-white/10 pt-8">
                  ...
                  {selectedProject.tags.map(tag => (
                    <span key={tag} className="px-3 py-1 bg-white/5 border border-white/10 text-xs font-mono text-neutral-300">
                      {tag}
                    </span>
                  ))}
                </div>
