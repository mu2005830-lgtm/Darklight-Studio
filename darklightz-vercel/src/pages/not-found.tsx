    ...
    <PublicLayout>
      <div className="flex-1 flex flex-col items-center justify-center bg-background min-h-[70vh] text-center px-6">
        ...
        <Link href="/" data-testid="link-404-return-home">
          <MagneticLink className="inline-flex h-14 px-8 rounded-full border border-border text-white font-display uppercase tracking-wider text-sm font-semibold items-center justify-center hover:bg-white hover:text-black transition-all group gap-2 cursor-pointer">
