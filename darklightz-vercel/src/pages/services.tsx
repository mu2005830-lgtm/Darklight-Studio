...
const STATIC_SERVICES: Service[] = [
  { id: 1, title: "Landing Page", slug: "landing-page", summary: "High-converting single-page websites that turn visitors into leads.", description: "", icon: "✦", sortOrder: 1, category: "website-services", heroImage: "", price: "From PKR 6,000", deliveryTime: "3–5 days", featuredBadge: "Popular", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 2, title: "Business Website", slug: "business-website", summary: "Professional multi-page websites that build credibility and drive growth.", description: "", icon: "✦", sortOrder: 2, category: "website-services", heroImage: "", price: "From PKR 15,000", deliveryTime: "7–10 days", featuredBadge: "", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 3, title: "Custom-Coded Website", slug: "custom-website", summary: "Fully bespoke websites with hand-crafted code for maximum performance.", description: "", icon: "✦", sortOrder: 3, category: "website-services", heroImage: "", price: "From PKR 30,000", deliveryTime: "14–21 days", featuredBadge: "Premium", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 4, title: "Shopify Website", slug: "shopify", summary: "Revenue-optimised Shopify stores built to convert browsers into buyers.", description: "", icon: "✦", sortOrder: 4, category: "website-services", heroImage: "", price: "From PKR 15,000", deliveryTime: "7–14 days", featuredBadge: "", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 5, title: "WordPress Website", slug: "wordpress", summary: "Elegant, scalable WordPress sites with custom themes and plugins.", description: "", icon: "✦", sortOrder: 5, category: "website-services", heroImage: "", price: "From PKR 10,000", deliveryTime: "7–10 days", featuredBadge: "", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 6, title: "Website Redesign", slug: "website-redesign", summary: "Transform your outdated site into a premium digital experience.", description: "", icon: "✦", sortOrder: 6, category: "website-services", heroImage: "", price: "From PKR 11,000", deliveryTime: "7–14 days", featuredBadge: "", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 7, title: "Bug Fixes", slug: "bug-fixes", summary: "Fast, reliable fixes for any website issue — guaranteed resolution.", description: "", icon: "✦", sortOrder: 7, category: "website-services", heroImage: "", price: "From PKR 2,000", deliveryTime: "1–3 days", featuredBadge: "", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 8, title: "Monthly Website Maintenance", slug: "website-maintenance", summary: "Ongoing care to keep your site secure, fast, and up-to-date.", description: "", icon: "✦", sortOrder: 8, category: "website-services", heroImage: "", price: "PKR 5,000/mo", deliveryTime: "Ongoing", featuredBadge: "", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 9, title: "Video Editing", slug: "video-editing", summary: "Cinematic edits that capture attention and keep viewers watching.", description: "", icon: "✦", sortOrder: 9, category: "content-creation", heroImage: "", price: "From PKR 3,000", deliveryTime: "2–4 days", featuredBadge: "", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 10, title: "UGC Content", slug: "ugc-content", summary: "Authentic user-generated style content that builds trust and drives sales.", description: "", icon: "✦", sortOrder: 10, category: "content-creation", heroImage: "", price: "From PKR 5,000", deliveryTime: "3–5 days", featuredBadge: "Trending", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
  { id: 11, title: "Monthly Content Management", slug: "content-management", summary: "Done-for-you content strategy, creation, and publishing every month.", description: "", icon: "✦", sortOrder: 11, category: "content-creation", heroImage: "", price: "PKR 15,000–20,000/mo", deliveryTime: "Ongoing", featuredBadge: "", whatsIncluded: [], processSteps: [], ctaText: "Get Started" },
]
          ...
          <BlurReveal delay={0.3}>
            <div className="mt-24 pt-16 border-t border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="https://wa.me/+923350501287?text=Hi, I'd like to discuss my project"
                  target="_blank"
