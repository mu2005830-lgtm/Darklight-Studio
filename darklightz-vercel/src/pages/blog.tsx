            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {posts?.map((post, i) => (
                <motion.article
                  ...
                  className="group flex flex-col h-full border border-white/5 bg-[#050505] rounded-[2px] hover:border-white/25 transition-colors"
                >
                  <Link href={`/blog/${post.slug}`} className="block aspect-[16/9] overflow-hidden bg-neutral-900 border-b border-white/5">
                    <img
