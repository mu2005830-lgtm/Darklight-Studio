...
-- 4. Add WhatsApp number to site settings
ALTER TABLE site_settings
  ADD COLUMN IF NOT EXISTS whatsapp_number text NOT NULL DEFAULT '+923351468615';

-- ============================================================================
-- 5. Seed the 11 services with CORRECT official pricing
